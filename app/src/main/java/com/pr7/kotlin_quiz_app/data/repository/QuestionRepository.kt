...
class QuestionRepository {
    ...
    fun getAllQuestions():ArrayList<QuestionModel> = arrayListOf(
        QuestionModel(question = "Bu Adobe Companiyasimi ? ?", image = R.drawable.adobe, option1 = "Adobe", option2 = "Google", option3 = "Yandex", option4 = "Youtube", answer = "Adobe"),
        ...
        QuestionModel(question = "Bu qaysi kompaniya ?", image = R.drawable.swift, option1 = "Swift", option2 = "Adobe", option3 = "Yandex", option4 = "Firebase", answer = "Swift"),
    )
}